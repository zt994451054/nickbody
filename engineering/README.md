...
|-------|------|---------|--------|---------|---------|---------|---------|
| `macos-app` | macOS 桌面客户端 | https://github.com/zt994451054/nickbody-macos | main | 见 `standards/engineering/standards.md` | `engineering/workspace/macos-app/` | 产品全部功能：疲劳追踪/提醒/跟练评分/宠物养成/订阅（Swift+SwiftUI+AppKit+Vision+RealityKit+Core Animation+SwiftData+StoreKit 2）| [README.md](https://github.com/zt994451054/nickbody-macos/blob/main/README.md) |
