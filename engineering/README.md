...
|-------|------|---------|--------|---------|---------|---------|---------|
| `macos-app` | macOS 桌面客户端 | 待创建 | main | 见 `standards/engineering/standards.md` | `engineering/workspace/macos-app/` | 产品全部功能：疲劳追踪/提醒/跟练评分/宠物养成/订阅（Swift+SwiftUI+Vision+Rive+SwiftData+StoreKit 2）| 待创建 |
