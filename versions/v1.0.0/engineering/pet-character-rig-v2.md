...
当前执行第 5 项。v002 静态拓扑和 32 关节无蒙皮骨位均已获得用户批准，工作范围推进到逐顶点区域 mask、手工权重和 Gate 0/1。蒙皮候选必须先通过权重数量、归一化、左右镜像、区域隔离和逐关节原尺寸审核；Gate 1 全部通过前不得执行 Gate 2，变形、动作和正式资源替换仍未获批准。
