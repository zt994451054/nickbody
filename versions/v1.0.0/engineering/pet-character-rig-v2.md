...
当前阻塞点是自然变形与表情控制。CHANGE-033 腰部场仍为加工 GLB；CHANGE-038 第二版减轻左膝下缘折痕，但内侧凹折未通过，仅保留形状参考。P2 两版预算已用完，下一项已选择内侧上缘局部权重修整，尚未实施，见 §8.0.17 与修复计划 §7。腰髋、全身及生产认证未通过；旧路线、正式 S0/32 关节合同和资源保持不变，诊断副本不直接改名为 v002 或正式绑定。
