...
4. **角色生产**：历史失败路线保持冻结，最后核实余额 190。basic 80k / native 41 骨及五动作链路已跑通，CHANGE-033 腰部场保留加工 GLB。CHANGE-058 K5 在既有容差与固定盒内仍线性不可行，精确定位 12 行原数学/实测折角冲突；111 项测试通过，无候选或 Blender。下一项只读审计面片组的两套预测差异及非线性余项，见修复计划 §27 / Rig v2 §8.0.37。K3 实际 169 行失败未解决，模型未修好，无非线性或整体无解证明。P2 2/2、S 2/2、C1/Q1/C2/C3/K1/K2/K3/K4/K5 各 1/1；K6 未登记，不自动 C4，D 未启动。表情、条件性贴图与 RealityKit 未完成；正式候选仍须通过 open-five S0、闭合身份、用户静态审核及固定骨架/Gate 0–3。
