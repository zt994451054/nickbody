...
4. **角色生产**：历史失败路线保持冻结。CHANGE-028/029 消费 35 credits、CHANGE-030 消费 260、CHANGE-031 消费 115，最后核实余额 190。basic 80k / native 41 骨及五动作链路已跑通。CHANGE-032～042 本地工作未新增消费，腰部场保留加工 GLB。P2/S1/D1/D2 均未修好左膝；CHANGE-042 点改产生新折角和大腿自身相交，原骨也不能表达其横向推拉。P2 2/2、S 1/2，S2 未启动；制作缺口与调整成本见修复计划 §11。左侧稳定并通过连续性/交付可行性后再处理右侧与原动作。表情、条件性贴图和 RealityKit 未完成。正式候选仍须通过 open-five S0、闭合身份和用户静态审核后进入固定骨架、蒙皮与 Gate 0–3；诊断产物不替换正式资源。详见 Rig v2 §8.0.21。
