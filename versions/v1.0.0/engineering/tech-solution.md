...
4. **角色生产**：当前接续为 CHANGE-068 [支撑连接与几何结果 §7](./pet-character-shoulder-migration-study.md)。1,024 点 / 976 四边面实物的支撑成带与核心一圈极点净空通过，几何退步（37 对自交、182 个不同折面）仍拒绝，下一项验证布点方法。全身工单保持、完整身体尚未开工。正式身份不变，Tripo 41 骨只作试验/运动参考，CHANGE-033 仍为 vendor 加工 GLB；B1、权重和旧路线关闭，旧预算不重开。详见 Rig v2 §8.0.47。S0、闭合身份/UV、用户审核、32 关节及 Gate 0–4 和运行时往返仍待完成；冻结 K3 的 169 条失败保持。最后核实余额 190，本轮未查询或消费，正式合同/资源保持。
