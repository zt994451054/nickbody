...
4. **角色生产**：历史失败路线保持冻结，最后核实余额 190。basic 80k / native 41 骨及五动作链路已跑通，CHANGE-033 腰部场保留加工 GLB。CHANGE-057 K4 零残差 QP 局部不可行，已修正折角编译严于既有门槛的问题；K5 初始问题已准备，驱动/登记待完成，见修复计划 §26 / Rig v2 §8.0.36。86 项测试通过，K3 实际 169 行失败仍未解决，模型未修好。P2 2/2、S 2/2、C1/Q1/C2/C3/K1/K2/K3/K4 各 1/1，不自动 C4，D 未启动。表情、条件性贴图与 RealityKit 未完成；正式候选仍须通过 open-five S0、闭合身份、用户静态审核及固定骨架/Gate 0–3。
